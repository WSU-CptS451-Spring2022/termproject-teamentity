...
-- DROP TABLE GoodMeals
-- DROP TABLE Ambience
-- DROP TABLE Parking
-- DROP TABLE HoursOfBusiness
-- DROP TABLE Friend
-- DROP TABLE Tips
-- DROP TABLE CheckIn
-- DROP TABLE UserInfo
...
CREATE TABLE UserInfo(
    ...
    accountTime CHAR(20) NOT NULL,
    funny INT NOT NULL,
    latitude2 NUMERIC(9, 5),
...
CREATE TABLE CheckIn(
    ...
    timeOfCheckIn CHAR(10) NOT NULL,
